<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="UpdateAccount.aspx.cs" Inherits="myfreelance.UpdateAccount" %>
...
<body>
  ...
  <div class="container">
    ...
    <asp:TextBox ID="update_license" runat="server" placeholder="NA" ></asp:TextBox>
    ...
    <asp:TextBox ID="update_id" runat="server" placeholder="Enter login ID" ></asp:TextBox>
      ...
      <label for="psw"><b>Password</b></label><asp:RequiredFieldValidator ID="rfv_password" runat="server" ErrorMessage="(Enter your password)" ControlToValidate="update_password" ForeColor="Red"></asp:RequiredFieldValidator><asp:RegularExpressionValidator ID="rgv_pass" runat="server" ErrorMessage="Password needs to be at least 8 characters" ControlToValidate="update_password" ForeColor="Red"  ValidationExpression=".{8}.*" ></asp:RegularExpressionValidator>
    <asp:TextBox ID="update_password" runat="server" placeholder="Enter new password" type="password"></asp:TextBox>
          <br />
